...
func Start(wg *sync.WaitGroup, config *hwproxy.SCConfiguration, fn func(e interface{}) error) error { //nolint:deadcode,unused
	err := hwproxy.Start(wg, config, fn) //nocheck
	if err != nil {
