...
var testCases = []TestCase{
	...
	{
		log:                    "ptp4l[4270543.688]: [ptp4l.1.config:5] port 2 (ens3f1): SLAVE to FAULTY on FAULT_DETECTED (FT_UNSPECIFIED)", // Will fail if run indpendently
		from:                   "master",
		process:                "ptp4l",
		iface:                  "ens3fx",
		logPtp4lConfigName:     logPtp4lConfigDualFollower.Name,
	...
	{
		log:                    "ptp4l[4270543.688]: [ptp4l.1.config:5] port 1 (ens3f0): SLAVE to FAULTY on FAULT_DETECTED (FT_UNSPECIFIED)", // Will fail if run indpendently
		from:                   "master",
		process:                "ptp4l",
		iface:                  "ens3f0",
