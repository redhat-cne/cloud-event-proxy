...
func SetUp() error {
	cleanUp()
	f, err := os.OpenFile(filepath.Join(dirToWatch, ptp4l0Conf), os.O_CREATE|os.O_WRONLY, 0o644)
	if err != nil {
...
func Test_Config(t *testing.T) {
	...
	err = os.WriteFile(filepath.Join(dirToWatch, ptp4l0Conf), []byte(newText), 0o600)
	assert.Nil(t, err)
	log.Info("waiting...")
