...
import (
	...
	"github.com/redhat-cne/cloud-event-proxy/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CloudV1beta1Interface interface {
	RESTClient() rest.Interface
	CloudEventSubscribersGetter
}

// CloudV1beta1Client is used to interact with features provided by the cloud.event.proxy.org group.
type CloudV1beta1Client struct {
	restClient rest.Interface
}

func (c *CloudV1beta1Client) CloudEventSubscribers(namespace string) CloudEventSubscriberInterface {
	return newCloudEventSubscribers(c, namespace)
}
